...
import { buildDayMapViewportPlan, isValidLngLat, type DayMapRecenterResult } from '../lib/dayMapViewport'
...
function applyViewportPlan(map: MapInstance, plan: ReturnType<typeof buildDayMapViewportPlan>) {
  if (plan.bounds) {
