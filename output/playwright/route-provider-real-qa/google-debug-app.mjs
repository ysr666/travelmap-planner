...
const outPath = path.join(outDir, 'google-debug-app-summary.json')
...
async function main() {
  ...
  try {
    ...
    await page.screenshot({ path: path.join(outDir, 'google-debug-app-after-confirm.png'), fullPage: true })
  } finally {
