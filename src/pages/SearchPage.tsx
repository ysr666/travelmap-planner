      ...
      <section className="space-y-3">
        ...
        <label className="relative block">
          ...
          <input
            autoComplete="off"
            autoFocus
            className="min-h-12 w-full rounded-lg border border-outline-variant/70 bg-surface-container py-3 pl-12 pr-4 font-body-md text-body-md text-on-surface shadow-[0_1px_2px_rgba(20,37,32,0.04)] outline-none transition placeholder:text-on-surface-variant focus:border-primary focus:ring-4 focus:ring-primary-fixed"
...
function SearchResultRow({ record, separator }: { record: LocalSearchRecord; separator: boolean }) {
  ...
  return (
    <button
      ...
      className="flex min-h-16 w-full items-center gap-3 px-4 py-3 text-left transition hover:bg-surface-container-high active:scale-[0.99] tm-focus"
...
function SearchLoading() {
  return (
    <div className="space-y-3 rounded-lg border border-outline-variant/70 bg-surface-container p-4">
...
function getRecordIcon(category: LocalSearchCategory) {
  if (category === 'trip') return { className: 'bg-primary text-on-primary', icon: <CalendarDays className="size-5" /> }
  ...
  if (category === 'transport') return { className: 'bg-primary-fixed text-primary dark:bg-primary/15 dark:text-primary-fixed-dim', icon: <TrainFront className="size-5" /> }
  return { className: 'bg-secondary-container text-secondary dark:bg-secondary/15 dark:text-secondary-fixed-dim', icon: <ReceiptText className="size-5" /> }
}
