...
const toneClasses: Record<InlineStatusTone, string> = {
  ...
  info: 'border-primary/15 bg-primary-fixed text-primary dark:border-primary/25 dark:bg-primary/10 dark:text-primary-fixed-dim',
...
export function InlineStatus({
  ...
  return (
    <div
      className={`flex items-start gap-2 rounded-lg border font-medium ${toneClasses[tone]} ${sizeClasses[size]} ${className}`}
      role={role}
    >
