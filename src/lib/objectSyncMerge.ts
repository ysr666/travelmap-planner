...
const FIELD_DEFS: Record<SyncObjectType, FieldDef[]> = {
  ...
  ledger_expense: [
    ...
    { label: '来源链', path: 'sourceLinks' },
    { label: '账单明细', path: 'lineItems' },
    { label: '商户', path: 'merchant' },
    { label: '城市', path: 'city' },
    { label: '订单号', path: 'orderNumber' },
    { label: '关联行程', path: 'itemIds' },
    { label: '预订时间', path: 'bookedAt' },
    { label: '付款时间', path: 'paidAt' },
    { label: '使用开始时间', path: 'serviceStartAt' },
    { label: '使用结束时间', path: 'serviceEndAt' },
    { label: '取消时间', path: 'cancelledAt' },
    { label: '退款时间', path: 'refundedAt' },
    { label: '付款状态', path: 'paymentStatus' },
    { label: '订单状态', path: 'orderStatus' },
    { label: '审核状态', path: 'reviewStatus' },
    { label: '识别置信度', path: 'recognitionConfidence' },
    { label: '自动确认原因', path: 'autoConfirmReason' },
    { label: '原账单', path: 'originalExpenseId' },
  ...
  replan_record: [
    ...
    { label: '操作类型', path: 'operationKind' },
    { label: '操作指纹', path: 'operationFingerprint' },
    { label: '操作范围', path: 'scopeItemIds' },
    { label: '方案', path: 'selectedOptionId' },
    { label: '状态', path: 'status' },
    { label: '基线指纹', path: 'baselineFingerprint' },
    { label: '应用指纹', path: 'appliedFingerprint' },
    { label: '撤销指纹', path: 'undoFingerprint' },
